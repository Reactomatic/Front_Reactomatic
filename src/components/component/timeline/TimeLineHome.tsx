...
import {OrbitingCirclesDemo} from "@/components/component/orbiting/OrbitingCircles";
    ...
    const data = [
        ...
        },
        {
            ...
            content: (
                <div>
                    <p className="text-neutral-800 dark:text-neutral-200 text-xl font-normal mb-8">
                        Reactomatic vous propose le meilleur prix grâce à son comparateur
                    </p>
